...
This document uses the Concise Data Definition Language (CDDL) {{I-D.ietf-cbor-cddl}} to express CBOR data structures {{I-D.ietf-cbor-7049bis}}. In the non-CDDL sections we use the "unwrap" operator "~" also for unwrapping byte strings, i.e. it is the opposite of "&lt;&lt; &gt;&gt;" that wraps a data item or group in a bstr. 

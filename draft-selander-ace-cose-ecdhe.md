...
When the certificates are identified with the x5chain header, the message sizes depends on the size of the (truncated) certificate chains. The COSE_Sign1 protected header will be 3 bytes + the size of the certificate chain.

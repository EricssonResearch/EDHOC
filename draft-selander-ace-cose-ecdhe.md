...
EDHOC is designed to work in highly constrained scenarios making it especially suitable for network technologies such as NB-IoT, 6TiSCH {{I-D.ietf-6tisch-dtsecurity-zerotouch-join}}, and LoRaWAN {{LoRa1}}{{LoRa2}}. Compared to the TLS 1.3 handshake {{I-D.ietf-tls-tls13}}, the number of bytes in EDHOC is approximately 1/3 when PSK authentication is used and 1/2 when RPK authentication is used, see {{app-sizes}}.

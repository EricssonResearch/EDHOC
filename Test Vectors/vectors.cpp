...
void psk_psk_vectors( void )
{
    ...
    // Derive PRK (PRK_2e = PRK_3e2m = PRK_4x3m)
   ...
   // Calculate CIPHERTEXT_2
    ...
    vector<uint8_t> K_2ae = hkdf_expand_sha_256( PRK, info_K_2ae, 16 );
    vector<uint8_t> info_IV_2ae = gen_info( cbor_tstr( "IV-GENERATION" ), 104, { }, TH_2 );
    vector<uint8_t> IV_2ae = hkdf_expand_sha_256( PRK, info_IV_2ae, 13 );
    ...
    vector<uint8_t> K_3ae = hkdf_expand_sha_256( PRK, info_K_3ae, 16 );
    vector<uint8_t> info_IV_3ae = gen_info( cbor_tstr( "IV-GENERATION" ), 104, { }, TH_3 );
    vector<uint8_t> IV_3ae = hkdf_expand_sha_256( PRK, info_IV_3ae, 13 );
    ...
    print_vector( "G_XY (ECDH shared secret)", shared_secret );
    print_vector( "salt", salt );
    print_vector( "PRK_2e = PRK_3m2m = PRK_4x3m", PRK );   
...
void sig_sig_vectors( void )
{
   ...
   // message_2 ////////////////////////////////////////////////////////////////////////////
    ...
    vector_append( CRED_R, cbor_bstr( R_sign_pk ) );
    ...
    vector<uint8_t> K_2m = hkdf_expand_sha_256( PRK, info_K_2m, 16 );
    vector<uint8_t> info_IV_2m = gen_info( cbor_tstr( "IV-GENERATION" ), 104, cbor_bstr( ID_CRED_R ), TH_2 );
    vector<uint8_t> IV_2m = hkdf_expand_sha_256( PRK, info_IV_2m, 13 );
    ...
    crypto_sign_detached( signature_or_MAC_2.data(), nullptr, M_2.data(), M_2.size(), R_sign_sk_libsodium.data() );
    ...
    vector<uint8_t> K_2e = hkdf_expand_sha_256( PRK, info_K_2e, P_2e.size() );
   ...
   // message_3 ////////////////////////////////////////////////////////////////////////////
    ...
    vector_append( CRED_I, cbor_bstr( I_sign_pk ) );
    ...
    vector<uint8_t> K_3m = hkdf_expand_sha_256( PRK, info_K_3m, 16 );
    vector<uint8_t> info_IV_3m = gen_info( cbor_tstr( "IV-GENERATION" ), 104, cbor_bstr( ID_CRED_I ), TH_3 );
    vector<uint8_t> IV_3m = hkdf_expand_sha_256( PRK, info_IV_3m, 13 );
    ...
    crypto_sign_detached( signature_or_MAC_3.data(), nullptr, M_3.data(), M_3.size(), I_sign_sk_libsodium.data() );
    ...
    print_cddl_int( 6 );
    cout << "  -2:";
    print_cddl_bstr( I_sign_pk );
    cout << "  -4:";
    print_cddl_bstr( I_sign_sk );
    cout << "}" << endl;
    ...
    print_cddl_int( 6 );
    cout << "  -2:";
    print_cddl_bstr( R_sign_pk );
    cout << "  -4:";
    print_cddl_bstr( R_sign_sk );
    cout << "}" << endl;
